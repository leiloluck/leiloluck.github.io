...
**Source:** https://www.saferparty.ch/substanzen/2c-b-2c-x
...
2C-B bzw. andere 2C-Substanzen (z.B. 2C-I, 2C-E, 2C-C) sind synthetisch hergestellte Meskalinderivate und gehören zur Gruppe der Psychedelika. Sie werden häufig zu den Neuen Psychoaktiven Substanzen gezählt und sind nur wenig erforscht. 2C-B stellt dabei den bekanntesten Ableger der Substanzreihe dar und wurde bereits in den 90er Jahren als "Nexus" oder "Erox" verkauft. 2C-B wirkt antriebssteigernd, wahrnehmungsverändernd und wird, vorwiegend in tieferen und mittleren Dosierungen, auch als Partydroge gebraucht.

---

## Wirkung (Effects)

Es stellt sich eine antriebssteigernde Wirkung ein. Wahrnehmungen und Gefühle werden intensiver, die Körpertemperatur sowie die Pulsfrequenz wird erhöht. Ab 10–15 mg 2C-B oder 2C-I (geschnupft bereits ab 7 mg) bekommt die Wirkung meist einen halluzinogenen Charakter. Die Grenzen zwischen Innen und Aussen können sich auflösen. Oft werden in höheren Dosierungen bewegende farbige Muster und leuchtende Felder um Gegenstände und Personen herum wahrgenommen. Der Rausch wird jedoch als weniger tiefgründig empfunden als bei LSD.

Andere 2C-x-Derivate wirken in einem ähnlichen Spektrum, sind jedoch teilweise um ein Vielfaches potenter und halluzinogener. Es ist daher notwendig, sich vor dem Konsum über die genaue Substanz, die Dosierung und die Wirkung zu informieren.

---

## Dauer (Duration)

- **Wirkungseintritt (Onset):**
...
2C-x-Derivate wirken schon in kleinen Mengen; bereits 2 mg mehr oder weniger können einen grossen Unterschied in der erlebten Wirkung ausmachen; ein schrittweises Herantasten an die individuelle Dosis wird empfohlen. Dosierungen über 35 mg 2C-B oder 2C-I oral können selbst von erfahrenen Konsumierenden als unangenehm stark empfunden werden.

**Erscheinungsformen:** Kristallines Pulver oder in Form von Pillen.
...
- Personen mit psychischen Problemen oder Erkrankungen, Personen, die Neuroleptika einnehmen, sowie Personen mit Kreislauf- und Herzproblemen sollten auf den Konsum verzichten oder zumindest tief dosieren.

---

## Mischkonsum (Drug Combinations)

- Mische 2C-B bzw. 2C-x nicht mit Alkohol oder Medikamenten!
- Der Mischkonsum von 2C-B und MDMA kann zu Krampfanfällen führen.
...
2C-B, 2C-I und andere 2C-x-Substanzen wirken aphrodisierend, die Lust auf Sex kann sich steigern. Beachte daher die Safer-Sex-Massnahmen!
