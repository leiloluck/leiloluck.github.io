...
|---|---|---|
| `harm-reduction-guide/` | Evidence-based harm-reduction protocols for festival/nightlife settings. 16 substances, sourced dosing, a regrounded risk chart, drug-combination data. | `harm-reduction-guide/context.md` |
